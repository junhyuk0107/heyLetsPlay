...
{	
	static String[] createDatabaseCreateTableSqls = {
		...
		"create table reservation("+
		   "reservation_num int NOT NULL AUTO_INCREMENT,"+	//값이 자동 증가함
		   "hotel_name varchar(40) NOT NULL,"+
		   "room_num int NOT NULL,"+
		   "c_id varchar(40) NOT NULL,"+
		...
		"create table reservation_cancellation("+
		   "reservation_cancellation_num int NOT NULL AUTO_INCREMENT,"+	//값이 자동 증가함
	...
	static String[] insertDefaultDataSqls= {
			...
			"insert into hotel values('힐튼 가든인 서울 강남', '서울특별시 서초구 강남대로 253', '010-1111-1111', 5, 'owner2', '2015-11-09');",
			...
			"insert into room values('힐튼 가든인 서울 강남', 101, '2015-11-09', 2, 120000, 22);",
			"insert into room values('힐튼 가든인 서울 강남', 102, '2015-11-09', 2, 120000, 22);",
			"insert into room values('힐튼 가든인 서울 강남', 103, '2015-11-09', 2, 120000, 22);",
			...
			"insert into reservation(hotel_name, room_num, c_id, reserve_date, start_date_of_use, end_of_use_date, payment_type, number_of_people) values('힐튼 가든인 서울 강남', 101, 'guest2', '2022-03-01', '2022-07-22', '2022-07-23', '신용카드', 4);",
			"insert into reservation(hotel_name, room_num, c_id, reserve_date, start_date_of_use, end_of_use_date, payment_type, number_of_people) values('힐튼 가든인 서울 강남', 101, 'guest3', '2022-03-01', '2022-07-02', '2022-07-03', '신용카드', 4);",
			"insert into reservation(hotel_name, room_num, c_id, reserve_date, start_date_of_use, end_of_use_date, payment_type, number_of_people) values('속초 컨피네스 비치 호텔', 101, 'guest3', '2022-03-01', '2022-07-22', '2022-07-23', '신용카드', 4);",
			"insert into reservation(hotel_name, room_num, c_id, reserve_date, start_date_of_use, end_of_use_date, payment_type, number_of_people) values('속초 컨피네스 비치 호텔', 101, 'guest4', '2022-03-01', '2022-07-02', '2022-07-03', '신용카드', 4);",
			...
			"insert into reservation(hotel_name, room_num, c_id, reserve_date, start_date_of_use, end_of_use_date, payment_type, number_of_people) values('신라스테이 삼성', 101, 'guest5', '2022-03-01', '2022-07-02', '2022-07-03', '신용카드', 4);",
			...
			"insert into reservation(hotel_name, room_num, c_id, reserve_date, start_date_of_use, end_of_use_date, payment_type, number_of_people) values('호텔 아르떼', 101, 'guest1', '2022-03-01', '2022-07-02', '2022-07-03', '신용카드', 4);",
			...
			"insert into reservation_cancellation(cancellation_charge, cancellation_date, hotel_name, room_num, c_id, reserve_date, start_date_of_use, end_of_use_date , payment_type, number_of_people) values(25000, '2022-04-04', '힐튼 가든인 서울 강남', 101, 'guest3', '2022-04-01', '2022-04-22', '2022-04-23', '신용카드', 3);",
			...
			"insert into reservation_cancellation(cancellation_charge, cancellation_date, hotel_name, room_num, c_id, reserve_date, start_date_of_use, end_of_use_date , payment_type, number_of_people) values(25000, '2022-04-04', '속초 컨피네스 비치 호텔', 101, 'guest4', '2022-04-01', '2022-04-22', '2022-04-23', '신용카드', 3);",
			...
			"insert into reservation_cancellation(cancellation_charge, cancellation_date, hotel_name, room_num, c_id, reserve_date, start_date_of_use, end_of_use_date , payment_type, number_of_people) values(25000, '2022-04-04', '신라스테이 삼성', 101, 'guest5', '2022-04-01', '2022-04-22', '2022-04-23', '신용카드', 3);",
			...
			"insert into reservation_cancellation(cancellation_charge, cancellation_date, hotel_name, room_num, c_id, reserve_date, start_date_of_use, end_of_use_date , payment_type, number_of_people) values(25000, '2022-04-04', '호텔 아르떼', 101, 'guest1', '2022-04-01', '2022-04-22', '2022-04-23', '신용카드', 3);",
	};
